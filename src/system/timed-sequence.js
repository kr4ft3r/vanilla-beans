...
class TimedSequence {
         ...
         * @property {TimedSequence~SequenceSegmentAction} action Callback to run when segment starts
        ...
        /**
         * @param {TimedSequence~TimedSequenceSegment[]} sequence Array of segments that define the sequence
