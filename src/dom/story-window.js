...
class StoryWindow {
        ...
        /**
         * 
         * @param {string[]|StoryWindow~StorySegment[]} sequence Array of objects containing `text` (string) and optional `action` (callback) that will be called before requesting write
         */
